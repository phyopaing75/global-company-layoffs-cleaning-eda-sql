...
patterns:
Aggregations & Trends: Evaluates peak layoff events, completely shut down companies
(100% laid off), and annual/monthly volume trajectories.
Cumulative Tracking: Uses Common Table Expressions (CTEs) and window functions
(SUM() OVER(...) ) to calculate rolling monthly totals over time.
